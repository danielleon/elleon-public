window.de_elleon_pub_vaadin_anonymizedgoogleanalyticstracker_AnonymizedGoogleAnalyticsTracker = function() {
    ...
    this.optOut = function() {
    	...
    	var state = self.getState();
    	var disableStr = state.COOKIE_NAME_PREFIX + state.trackerId;
